                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="product">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name"><a href="<?php echo 'product.php?id=' . $p['id'] ?>"><?php echo substr($p['name'], 0, 23) ?></a>
                                            </h3>
                                            <h4 class="product-price">
                                                <?php echo  number_format($p['price'] - $p['price'] * $p['discount'] / 100) . "VNĐ"; ?>
                                                <br>
                                                <del class="product-old-price"><?php echo  number_format($p['price']) . " VNĐ"; ?></del>
                                            </h4>
                                            ...
                                            <div class="product-btns">
                                                <button class="add-to-wishlist"><a href="delViewwishlist.php?id=<?php echo $key ?>&&pages<?php echo $_GET['pages'] ?>"><i class="fa fa-heart" style="color:red"></i><span class="tooltipp">del to
                                        ...
                                        <div class="add-to-cart">
                                            <a href="<?php echo  $link; ?>"><button type="submit" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to
                                                    cart</button></a>
                                        </div>
